...
const deleteUser = async (userName,countryId,comments,pool) => {
  ...
  await pool.query(`update "user" set is_active = false, is_deleted = true, comments = $2 where id = $1`,[userId,comments]);
  return {
    id: userId,
